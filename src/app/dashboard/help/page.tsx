...
const sections = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Reel — pick a look: four styles, each a complete treatment. Editorial (serif caps on a soft gradient, the brochure look), Cinematic (letterboxed and slow, nothing over the photograph), Gallery (warm off-white with the photo inset), Classic (warm tones, title case, set lower-left — suits sail and classics).",
      "Reel — options: choose the photos and their order, put the price and location on or off, show the whole photo or fill the frame, and switch on room labels to name each space on screen. Reels run about 20 seconds, which is where they hold attention best.",
      ...
      "Reel — Send to my phone: once the reel is made, this puts a QR code on screen. Point your phone's camera at it, tap, and the reel saves to your camera roll ready to post with your own audio. The same link is emailed to you as a backup and works for 24 hours.",
