...
const sections = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Reel — pick a look: five styles, each a complete treatment. Editorial (serif caps on a soft gradient, the brochure look), Cinematic (letterboxed and slow, nothing over the photograph), Gallery (warm off-white with the photo inset), Classic (warm tones, title case, set lower-left — suits sail and classics), Energy (hard cuts and a quick punch-in, about 15 seconds — for centre consoles and sportfish).",
