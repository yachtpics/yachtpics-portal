export default function TermsPage() {
  ...
  return (
    <div className="px-6 py-10 max-w-3xl mx-auto">
      <p className="label-caps mb-2">License</p>
      <h1 className="text-display text-ink-900 mb-1">Photo &amp; Video License Terms</h1>
      <p className="text-sm text-ink-500 mb-10">Effective {effectiveDate}</p>

      <div className="max-w-none space-y-8">

        <section className="border-t border-hairline pt-6">
          <h2 className="text-h2 text-ink-900 mb-2">1. Copyright Ownership</h2>
        ...
        <section className="border-t border-hairline pt-6">
          <h2 className="text-h2 text-ink-900 mb-2">2. License Grant</h2>
          <p className="text-sm text-ink-600 leading-relaxed">
        ...
        <section className="border-t border-hairline pt-6">
          <h2 className="text-h2 text-ink-900 mb-2">3. Restrictions</h2>
          ...
          <ul className="text-sm text-ink-600 space-y-2 list-none pl-0">
            <li className="flex items-start gap-2"><span className="text-danger-500 shrink-0 mt-0.5">✕</span><span><strong>Transfer or share</strong> the Content with any other broker, brokerage, co-listing agent, or third party for their own advertising or commercial use.</span></li>
            <li className="flex items-start gap-2"><span className="text-danger-500 shrink-0 mt-0.5">✕</span><span><strong>Sublicense or resell</strong> the Content to any individual, company, stock photo library, or marketing agency.</span></li>
            <li className="flex items-start gap-2"><span className="text-danger-500 shrink-0 mt-0.5">✕</span><span><strong>Use the Content for a different vessel</strong> than the one it was created for, or represent it as depicting a vessel other than the one photographed.</span></li>
            <li className="flex items-start gap-2"><span className="text-danger-500 shrink-0 mt-0.5">✕</span><span><strong>Remove or alter</strong> any copyright watermarks, metadata, or attribution embedded in or associated with the Content.</span></li>
            <li className="flex items-start gap-2"><span className="text-danger-500 shrink-0 mt-0.5">✕</span><span><strong>Grant access</strong> to the Content to any party not employed by or working directly on behalf of your brokerage in connection with the listed vessel.</span></li>
          </ul>
        </section>

        <section className="border-t border-hairline pt-6">
          <h2 className="text-h2 text-ink-900 mb-2">4. Broker-Uploaded Content</h2>
          <p className="text-sm text-ink-600 leading-relaxed">
        ...
        <section className="border-t border-hairline pt-6">
          <h2 className="text-h2 text-ink-900 mb-2">5. Credit &amp; Attribution</h2>
          <p className="text-sm text-ink-600 leading-relaxed">
        ...
        <section className="border-t border-hairline pt-6">
          <h2 className="text-h2 text-ink-900 mb-2">6. Termination</h2>
          <p className="text-sm text-ink-600 leading-relaxed">
        ...
        <section className="border-t border-hairline pt-6">
          <h2 className="text-h2 text-ink-900 mb-2">7. Enforcement</h2>
          <p className="text-sm text-ink-600 leading-relaxed">
        ...
        <section className="border-t border-hairline pt-6">
          <h2 className="text-h2 text-ink-900 mb-2">8. Contact</h2>
          <p className="text-sm text-ink-600 leading-relaxed">
            For licensing inquiries or questions about these terms, please contact YachtPics at{" "}
            <a href="mailto:hello@yachtpics.com" className="text-accent-700 hover:text-accent-600 underline transition-colors duration-fast">
              hello@yachtpics.com
            </a>.
          </p>
        </section>
