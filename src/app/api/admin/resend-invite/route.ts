...
export async function POST(req: NextRequest) {
  ...
  const htmlLines = [
    ...
    "      </div>",
    "      <a href=\"https://portal.yachtpics.com/auth/login\" style=\"display:inline-block;background:#d4a843;color:#050b14;text-decoration:none;font-weight:600;font-size:15px;padding:14px 28px;border-radius:8px;margin-bottom:20px;\">Log In to Your Portal &rarr;</a>",
