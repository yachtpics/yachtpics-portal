...
export async function POST(req: NextRequest) {
  try {
    ...
    // Resolve any existing account for this email (reliable regardless of how
    // many accounts exist — see findExistingUser).
    ...
    if (existing) {
      ...
      const htmlLines = [
        ...
        "      </div>",
        "      <a href=\"https://portal.yachtpics.com/auth/login\" style=\"display:inline-block;background:#c39e4e;color:#050b14;text-decoration:none;font-weight:600;font-size:15px;padding:14px 28px;border-radius:8px;margin-bottom:24px;\">Log In to Your Account &rarr;</a>",
