...
- `public/icons/icon-192.png`, `icon-512.png`, `icon-maskable-512.png` — **placeholder** icons.
...
1. **Replace the placeholder icons** in `public/icons/` with real branded "YP" assets (same filenames/sizes). They're plain navy + "YP" right now.
2. Optionally add an `apple-touch-icon` at `public/apple-icon.png` (180×180) — Next App Router will auto-serve it.
